...
**KB geography coefficent can capture the issues of measurement between the two places. But combining them together is 
kb: use caseweights https://www.tidyverse.org/blog/2022/05/case-weights/
